...
Additionally, if your reason for testing against Roles is for a Super-Admin, see the [Defining A Super-Admin](advanced-usage/defining-a-super-admin.md) section of the docs.
